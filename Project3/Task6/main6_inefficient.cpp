...
///*---------------------------------------------------------------------------*/
//
//void perform_greyscale_closing(my_image_comp* in, my_image_comp* out,
...
//            int min_max = 255;
//            // Go to each pixel n_p in the region
//            for (int n = 0; n < N; n++)
//            {
//                float* n_p = in->buf + n1 * in->stride + n2 + A_off.at(n);
//                // Find the maximum in that pixel's region
//                int region_max = 0;
//                for (int region = 0; region < N; region++)
//                {
//                    if (n_p[A_off.at(region)] > region_max)
//                        region_max = n_p[A_off.at(region)];
//                }
//                // Find the minimum of the maximums of each region
//                if (region_max < min_max)
//                    min_max = region_max;
//            }
//            *op = min_max;
//        }
...
//        for (n = 0; n < num_comps; n++)
//            perform_greyscale_closing(input_comps + n, output_comps + n, A_mirror, N, border, debug);
//
//        /*-------------------------------------------------------------------------*/
//
